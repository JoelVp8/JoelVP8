...
- **Ingeniería de Proyectos**: Puesta en marcha, validación, comisionado de sistemas
- **Roles**: Defensa (FPGA), Startups (embebidos), Ferrocarriles (Talgo - proyectos)

### 🛠️ Tech Stack & Herramientas

![VHDL](https://img.shields.io/badge/VHDL-E34C26?style=flat-square&logo=vhdl)
![C](https://img.shields.io/badge/C-00599C?style=flat-square&logo=c)
![STM32](https://img.shields.io/badge/STM32-03234B?style=flat-square&logo=stmicroelectronics)
![Xilinx](https://img.shields.io/badge/Xilinx-0076BA?style=flat-square)
![Lattice](https://img.shields.io/badge/Lattice-FF6B35?style=flat-square)
...
- **Safety-Critical**: EN 50128, IEC 61508, BSP Design
- **Project Engineering**: Commissioning, validation, system V&V
- **Roles**: Defense (FPGA), Startups (embedded), Railway (Talgo - projects)
